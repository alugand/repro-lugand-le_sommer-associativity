...
This branch contains the code associated to the generator replicability factor. We try to change the random number generator and observe the results in answer_associativity.txt.
